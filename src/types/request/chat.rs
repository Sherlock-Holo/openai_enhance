...
impl Role {
    const fn can_truncate(&self) -> bool {
        matches!(self, Role::Assistant | Role::User)
    }
}
...
pub struct ChatCompletionAudio {
    ...
    /// recommended are `alloy`, `echo`, and `shimmer`; these voices are less
    /// expressive).
...
pub struct CreateChatCompletionRequest {
    ...
    ///
    /// for use in our [model distillation](https://platform.openai.com/docs/guides/distillation)
    ...
    /// completion, including visible output tokens and [reasoning tokens](https://platform.openai.com/docs/guides/reasoning).
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    /// with [GPT-4o](https://platform.openai.com/docs/models/gpt-4o), [GPT-4o mini](https://platform.openai.com/docs/models/gpt-4o-mini), [GPT-4 Turbo](https://platform.openai.com/docs/models/gpt-4-and-gpt-4-turbo) and all GPT-3.5 Turbo models newer than `gpt-3.5-turbo-1106`.
    ///
    /// Setting to `{ "type": "json_schema", "json_schema": {...} }` enables
    /// Structured Outputs which guarantees the model will match your supplied JSON schema. Learn more in the [Structured Outputs guide](https://platform.openai.com/docs/guides/structured-outputs).
    ///
    ...
    /// 0.8 will make the output more random,
...
pub struct ChatCompletionStreamOptions {
    ...
    /// always be an empty array. All other chunks will also include
...
pub struct ChatCompletionTokenLogprob {
    ...
    /// position. In rare cases, there may be fewer than the number of
...
pub struct FunctionCallStream {
    ...
    /// parameters not defined by your function schema. Validate the arguments
    /// in your
...
pub struct CreateChatCompletionStreamResponse {
    ...
    /// `n` is greater than 1. Can also be empty for the last chunk if you set
