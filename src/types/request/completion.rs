// all of them are copied from async-openai

use std::collections::HashMap;

use serde::{Deserialize, Serialize};

use super::chat::{ChatCompletionStreamOptions, Choice, CompletionUsage, Prompt, Stop};

#[derive(Clone, Serialize, Deserialize, Debug, PartialEq)]
pub struct CreateCompletionRequest {
    /// ID of the model to use. You can use the
    /// [List models](https://platform.openai.com/docs/api-reference/models/list) API to see all of
    /// your available models, or see our
    /// [Model overview](https://platform.openai.com/docs/models/overview) for descriptions of them.
    pub model: String,
...
pub struct CreateCompletionResponse {
    ...
    /// understand when backend changes have been
